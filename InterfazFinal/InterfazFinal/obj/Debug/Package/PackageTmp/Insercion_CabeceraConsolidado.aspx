<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_CabeceraConsolidado.aspx.cs" Inherits="InterfazConsolidado.Insercion_CabeceraConsolidado" %>
    ...
    <section class="home-section">
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <p>
                    Codigo Estudiante <asp:TextBox ID="cod_es" runat="server"></asp:TextBox>
                    <br /><br />
                </p>
                <p>
                    Codigo Escuela Profesional <asp:TextBox ID="cod_ep" runat="server"></asp:TextBox>
                    <br /><br />
                </p>
                <p>
                    Semestre Base <asp:TextBox ID="semestreb" runat="server"></asp:TextBox>
                    <br /><br />
                </p>
                <p>
                    Semestre Academico <asp:TextBox ID="semestreaca" runat="server"></asp:TextBox>
                    <br /><br />
                </p>
                <p>
                    Total de Creditos <asp:TextBox ID="total_cre" runat="server"></asp:TextBox>
                    <br /><br />
                </p>
                <p>
                    Ponderado General <asp:TextBox ID="pond_general" runat="server"></asp:TextBox>
                    <br /><br />
                </p>
                <p>
                    Ponderado Semestre <asp:TextBox ID="pond_sem" runat="server"></asp:TextBox>
                    <br /><br />
                </p>
                <p>
                    Orden de Mérito <asp:TextBox ID="orden" runat="server"></asp:TextBox>
                    <br /><br />
                </p>
                <p>
                ...
                <p>
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Mostrar Estudiantes" />
                ...
                <p>
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Mostrar Escuela Profesional" />
                </p>
                <p>
