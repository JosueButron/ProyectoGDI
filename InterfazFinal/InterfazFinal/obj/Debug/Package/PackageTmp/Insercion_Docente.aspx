<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_Docente.aspx.cs" Inherits="InterfazConsolidado.Insercion_Docente" %>
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    ...
                    <br /><br />
                    Apellido_P <asp:TextBox ID="apellidop" runat="server"></asp:TextBox>
                    <br /><br />
                    P_Nombre <asp:TextBox ID="nombre" runat="server"></asp:TextBox>
                    <br /><br />
                    Apellido_M <asp:TextBox ID="apellidom" runat="server"></asp:TextBox>
                    <br /><br />
                    Sexo <asp:TextBox ID="sexo" runat="server"></asp:TextBox>
                    <br /><br />
