<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_Asignatura.aspx.cs" Inherits="InterfazConsolidado.Insercion_Asignatura" %>
    ...
    <section class="home-section">
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    Codigo <asp:TextBox ID="codigo" runat="server"></asp:TextBox>
                    <br /><br />
                    Sede <asp:TextBox ID="sede" runat="server"></asp:TextBox>
                    <br /><br />
                    Nombre <asp:TextBox ID="nombre" runat="server"></asp:TextBox>
                    <br /><br />
                    Grupo <asp:TextBox ID="grupo" runat="server"></asp:TextBox>
                    <br /><br />
                    Seccion <asp:TextBox ID="seccion" runat="server"></asp:TextBox>
                    <br /><br />
                    Tipo <asp:TextBox ID="tipo" runat="server"></asp:TextBox>
                    <br /><br />
                    CR_PRA <asp:TextBox ID="cr_pra" runat="server"></asp:TextBox>
                    <br /><br />
                    CR_TEO <asp:TextBox ID="cr_teo" runat="server"></asp:TextBox>
                    <br /><br />
                    Codigo_EP <asp:TextBox ID="codigo_ep" runat="server"></asp:TextBox>
                    <br /><br />
                    ...
                    <br />
                    <br />
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Mostrar Escuela Profesional" />
                    <br />
                    <br />
                    <br /><br />
