<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Eliminar_DetalleConsolidado_Registro.aspx.cs" Inherits="InterfazConsolidado.Eliminar_DetalleConsolidado_Registro" %>
...
<body>
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <span class="text">ELIMINACIÓN</span>

        </div>
        <div class="home-section">
            <form id="form1" runat="server">
        <div>
            <asp:Label ID="El" runat="server" Text="Eliminación detalle Consolidado por Registro:"></asp:Label>
            <br /><br />
            <asp:Label ID="Label1" runat="server" Text="Ingrese el Codigo del Estudiante:"></asp:Label>
&nbsp;<asp:TextBox ID="codestu" runat="server"></asp:TextBox>
            <br /><br />
            <asp:Label ID="Label12" runat="server" Text="Ingrese el Codigo de la Asignatura"></asp:Label>
&nbsp;<asp:TextBox ID="codasig" runat="server"></asp:TextBox>
            <br />
            <br />
