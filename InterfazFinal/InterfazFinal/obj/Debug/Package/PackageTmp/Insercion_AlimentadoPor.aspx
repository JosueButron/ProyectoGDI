<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_AlimentadoPor.aspx.cs" Inherits="InterfazConsolidado.Insercion_AlimentadoPor" %>
    ...
    <section class="home-section">
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    Codigo Estudiante <asp:TextBox ID="codestu" runat="server"></asp:TextBox>
                    <br /><br />
                    Codigo Asignatura <asp:TextBox ID="codasi" runat="server"></asp:TextBox>
                    <br /><br />
                    Codigo Docente <asp:TextBox ID="coddoce" runat="server"></asp:TextBox>
                    <br /><br />
