<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_DetalleConsolidado.aspx.cs" Inherits="InterfazConsolidado.Insercion_DetalleConsolidado" %>
...
<body>
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <span class="text">INSERCIÓN</span>

        </div>
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    <asp:Label ID="Label1" runat="server" Text="Codigo Asignatura"></asp:Label>
                    &nbsp;<asp:TextBox ID="codigoasig" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label2" runat="server" Text="Codigo Estudiante"></asp:Label>
                    &nbsp;<asp:TextBox ID="codigoestu" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label3" runat="server" Text="Teo Nota 1"></asp:Label>
                    &nbsp;<asp:TextBox ID="teo1" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label4" runat="server" Text="Teo Nota 2"></asp:Label>
                    &nbsp;<asp:TextBox ID="teo2" runat="server" Height="22px"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label5" runat="server" Text="Teo Nota 3"></asp:Label>
                    &nbsp;<asp:TextBox ID="teo3" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label8" runat="server" Text="Practica Nota 1"></asp:Label>
                    &nbsp;<asp:TextBox ID="prac1" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label6" runat="server" Text="Practica Nota 2"></asp:Label>
                    &nbsp;<asp:TextBox ID="prac2" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label7" runat="server" Text="Practica Nota 3"></asp:Label>
                    &nbsp;<asp:TextBox ID="prac3" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label9" runat="server" Text="Promedio Practica"></asp:Label>
                    &nbsp;<asp:TextBox ID="promprac" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label10" runat="server" Text="Promedio Parcial"></asp:Label>
                    &nbsp;<asp:TextBox ID="prompar" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label12" runat="server" Text="Aplazados"></asp:Label>
                    &nbsp;<asp:TextBox ID="apl" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label13" runat="server" Text="Promedio FINAL"></asp:Label>
                    &nbsp;<asp:TextBox ID="promfinal" runat="server"></asp:TextBox>
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Mostrar Asignatura" />
                    ...
                    <br /><br />
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Mostrar Estudiante" />
