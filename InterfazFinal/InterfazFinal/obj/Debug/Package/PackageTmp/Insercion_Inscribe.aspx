<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_Inscribe.aspx.cs" Inherits="InterfazConsolidado.Insercion_Inscribe" %>
    ...
    <section class="home-section">
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    Codigo_Asignatura <asp:TextBox ID="cod_asi" runat="server"></asp:TextBox>
                    <br /><br />
                    Codigo_Alumno <asp:TextBox ID="cod_alu" runat="server"></asp:TextBox>
                    <br /><br />
