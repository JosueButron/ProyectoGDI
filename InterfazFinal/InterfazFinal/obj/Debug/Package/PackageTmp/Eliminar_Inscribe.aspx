<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Eliminar_Inscribe.aspx.cs" Inherits="InterfazConsolidado.Eliminar_Inscribe" %>
...
<body>
    ...
    <section class="home-section">
        ...
        <div>
            Ingrese los datos que se desea eliminar en el registro Inscribe<br /><br />
            Ingrese el codigo de Estudiante <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            <br /><br />
            Ingrese el codigo de Asignatura<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
            <br /><br />
