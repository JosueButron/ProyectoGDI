<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Eliminar_DetalleConsolidado_Completo.aspx.cs" Inherits="InterfazConsolidado.Eliminar_DetalleConsolidado_Completo" %>
...
<body>
    ...
    <section class="home-section">
        ...
        <div>
            <asp:Label ID="El" runat="server" Text="Eliminación detalle Consolidado Completo:"></asp:Label>
            <br /><br />
            <asp:Label ID="Label1" runat="server" Text="Ingrese el Codigo del Alumno:"></asp:Label>
