...
{
    public partial class Eliminar_Docente : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string insertSQL = "exec sp_elimina_docente '" + TextBox1.Text + "'";
            ...
            try
            {
                con.Open();
                cmd.ExecuteNonQuery();
                Label1.Text = "Docente eliminado con exito";
                con.Close();
                TextBox1.Text = "";
            ...
            {
                Label1.Text = "Error al eliminar docente";
