<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modificar_Estudiante.aspx.cs" Inherits="Interfaz.Modificar_Estudiante" %>
...
<body>
    ...
    <section class="home-section">
        ...
        <div>
            <br />
            Ingrese el Codigo de alumno a actualizar:<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            <br />
            <br />
            Elija el campo a actualizar:<asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" RepeatDirection="Horizontal">
                ...
                <asp:ListItem Value="5">TipoMatricula</asp:ListItem>
                <asp:ListItem Value="6">Categoria</asp:ListItem>
            </asp:RadioButtonList>
            <br />
            <br />
            <asp:MultiView ID="MultiView1" runat="server" OnActiveViewChanged="MultiView1_ActiveViewChanged">
                ...
                <asp:View ID="View7" runat="server">
                    Ingrese la categoria a&nbsp; actualizar:<asp:TextBox ID="TextBox8" runat="server"></asp:TextBox>
                    <br />
