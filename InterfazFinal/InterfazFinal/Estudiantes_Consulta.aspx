<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estudiantes_Consulta.aspx.cs" Inherits="Interfaz.Estudiantes_Consulta" %>
...
<body>
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <span class="text">CONSULTA ESTUDIANTES</span>
...
&nbsp;<asp:TextBox ID="codigoestu" runat="server"></asp:TextBox>
            <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Mostrar Consolidado" />
&nbsp;<br />
            <br />
            <br />
            Codigo EP:
            ...
            <br />
            <br />
            Tipo matricula: <asp:Label ID="Label20" runat="server"></asp:Label>
            &nbsp;&nbsp; TotalCreditos:
