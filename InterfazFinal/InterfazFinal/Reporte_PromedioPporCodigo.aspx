<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reporte_PromedioPporCodigo.aspx.cs" Inherits="InterfazFinal.Reporte_PromedioPporCodigo" %>
...
<body>
    ...
    <section class="home-section">
        ...
        <div>
            Ingrese el codigo de estudiante que desee saber el promedio ponderado:<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            <br />
            <br />
