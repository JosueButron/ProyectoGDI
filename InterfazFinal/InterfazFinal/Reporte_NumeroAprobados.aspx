<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reporte_NumeroAprobados.aspx.cs" Inherits="InterfazFinal.Reporte_NumeroAprobados" %>
...
<body>
    ...
    <section class="home-section">
        ...
        <div>
            Numero de Aprobados<br />
            <br />
            Ingrese codigo de asignatura:
            <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="height: 26px" Text="mostrar" />
            <br />
            <br />
