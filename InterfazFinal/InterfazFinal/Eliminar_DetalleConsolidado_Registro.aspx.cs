...
{
    public partial class Eliminar_DetalleConsolidado_Registro : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string insertSQL = "exec sp_eliminacion_detalle_consolidado_por_registro'" + codestu.Text +
                "', '" + codasig.Text + "'";
            ...
            {
                Label11.Text = "Error al eliminar registro de Detalle Consolidado, registro no existe";
