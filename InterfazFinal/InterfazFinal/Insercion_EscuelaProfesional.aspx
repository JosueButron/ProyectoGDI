<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_EscuelaProfesional.aspx.cs" Inherits="InterfazConsolidado.Insercion_EscuelaProfesional" %>
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    ...
                    <br /><br />
                    Escuela Profesional <asp:TextBox ID="escuela_prof" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                    <br /><br />
                    <asp:Button ID="Submit" runat="server" OnClick="Submit_Click" Text="Insertar" />
                    <br /><br />
                </div>
            </form>
        </div>
