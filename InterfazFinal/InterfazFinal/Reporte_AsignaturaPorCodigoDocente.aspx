<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reporte_AsignaturaPorCodigoDocente.aspx.cs" Inherits="InterfazFinal.Reporte_AsignaturaPorCodigoDocente" %>
...
<body>
    ...
    <section class="home-section">
        ...
        <div>
            Muestra Asignaturas impartidas por un docente<br />
            <br />
            Ingrese codigo del Docente:&nbsp; <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            <br />
            <br />
