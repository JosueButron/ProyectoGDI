<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_CabeceraListado.aspx.cs" Inherits="InterfazConsolidado.Insercion_CabeceraListado" %>
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    ...
                    <br /><br />
                    Codigo Asignatura <asp:TextBox ID="codasig" runat="server"></asp:TextBox>
                    <br /><br />
                    Semestre <asp:TextBox ID="semestre" runat="server"></asp:TextBox>
                    <br /><br />
                    ...
                    <br />
                    <br />
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Mostrar Docente" />
                    ...
                    <br /><br />
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Mostrar Asignatura" />
