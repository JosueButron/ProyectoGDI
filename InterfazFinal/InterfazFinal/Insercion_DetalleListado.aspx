<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_DetalleListado.aspx.cs" Inherits="InterfazConsolidado.Insercion_DetalleListado" %>
    ...
    <section class="home-section">
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    Codigo Estudiante <asp:TextBox ID="cod_estu" runat="server"></asp:TextBox>
                    <br /><br />
                    Codigo Asignatura <asp:TextBox ID="cod_asi" runat="server"></asp:TextBox>
                    <br /><br />
                    Codigo Docente <asp:TextBox ID="cod_doce" runat="server"></asp:TextBox>
                    <br /><br />
                    Subsanacion <asp:TextBox ID="subsa" runat="server"></asp:TextBox>
                    <br /><br />
                    Nota 1 <asp:TextBox ID="nota1" runat="server"></asp:TextBox>
                    <br /><br />
                    Nota 2 <asp:TextBox ID="nota2" runat="server"></asp:TextBox>
                    <br /><br />
                    Nota 3 <asp:TextBox ID="nota3" runat="server"></asp:TextBox>
                    <br /><br />
                    Vez <asp:TextBox ID="vez" runat="server"></asp:TextBox>
                    <br /><br />
                    Promedio <asp:TextBox ID="prom" runat="server"></asp:TextBox>
                    <br /><br />
                    ...
                    <br />
                    <br />
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Mostrar Estudiante" />
                    ...
                    <br /><br />
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Mostrar Asignaturas" />
                    ...
                    <br /><br />
                    <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Mostrar Docentes" />
