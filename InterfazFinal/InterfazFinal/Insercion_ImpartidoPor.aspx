<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_ImpartidoPor.aspx.cs" Inherits="InterfazConsolidado.Insercion_ImpartidoPor" %>
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    ...
                    <br /><br />
                    Codigo Docente <asp:TextBox ID="cod_doc" runat="server"></asp:TextBox>
                    <br /><br />
                ...
                <p>
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Mostrar Docente" />
