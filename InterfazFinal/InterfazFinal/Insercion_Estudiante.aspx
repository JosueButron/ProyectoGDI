<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insercion_Estudiante.aspx.cs" Inherits="InterfazConsolidado.Insercion_Estudiante" %>
        ...
        <div class="home-section">
            <form id="form1" runat="server">
                <div>
                    ...
                    &nbsp;<asp:TextBox ID="apellido_p" runat="server"></asp:TextBox>
                    <br /><br />
                    ...
                    &nbsp;<asp:TextBox ID="catego" runat="server"></asp:TextBox>
                    <br /><br />
                    <asp:Label ID="Label10" runat="server" Text="Tipo de Matricula"></asp:Label>
                    &nbsp;<asp:TextBox ID="tipo_mat" runat="server"></asp:TextBox>
                    <br />
                    <br />
